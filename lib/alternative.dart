      ...
      body: Column(
        children: [
          Row(
            ...
            children: [
              ElevatedButton(onPressed: () {}, child: Text("OLL Algorithms")),
              ElevatedButton(onPressed: () {}, child: Text("PLL Algorithms")),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
